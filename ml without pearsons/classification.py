...
folders = sorted(listdir(folder_path))[2:11]
folders
...
test4.columns = ["Family", "Int1 (magtropy)", "EIIP (magtropy)", "JustA (magtropy) "]
test4
...
np.average([17, 3.46410162, 2 , 3, 2, 3.46410162])
entropy_dict["Test8"] = entropy_values
entropy("CGATAT")
df2 = pd.DataFrame.from_dict(entropy_dict["Test8"])
df2.columns =["Family", "Int1 (magtropy)", "EIIP (magtropy)", "JustA (magtropy)"]

...
for family in my_dict["Test1b"].keys():
    for file in my_dict["Test1b"][family]:
        ...
        entropy_values.append((family, magtropy(final_seq)[0], magtropy(final_seq)[1], magtropy(final_seq)[2], magtropy(final_seq)[3]))
...
test1b.columns = ["Family", "int1", "EIIP", "JustA",  "JustG"]
test1b
len(start_seq)

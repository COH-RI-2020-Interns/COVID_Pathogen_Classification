...
enter_virus=driver.find_element_by_css_selector("#typeahead-input-VirusLineage_ss").send_keys("riboviria") #Change sublevel
time.sleep(2)
...
enter_start_date=driver.find_element_by_xpath("//*[@id='CreateDate_dt_From']").send_keys("1/1/2016") #start date
time.sleep(1)
...
enter_end_date.send_keys("12/31/2018")  #end date

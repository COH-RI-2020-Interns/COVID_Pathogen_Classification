...
print(confusion_matrix(predict, covid_df2["Sublevel Name"]))

# Nobecovirus 2020
nobecovirus = seq_separation_lst("00_Nobecovirus", 100)
...
X_test3 = nobecovirus_df.drop(columns = ["Sublevel Name"]) #these are the testing features
predict3 = my_model.predict(X_test3)
predict3
